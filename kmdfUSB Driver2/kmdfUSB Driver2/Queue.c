...
#ifdef ALLOC_PRAGMA
#pragma alloc_text (PAGE, kmdfUSBDriver2QueueInitialize)
#endif

NTSTATUS
kmdfUSBDriver2QueueInitialize(
...
--*/
{
    ...
    queueConfig.EvtIoDeviceControl = kmdfUSBDriver2EvtIoDeviceControl;
    queueConfig.EvtIoStop = kmdfUSBDriver2EvtIoStop;
...
VOID
kmdfUSBDriver2EvtIoDeviceControl(
    _In_ WDFQUEUE Queue,
